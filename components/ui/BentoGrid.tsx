...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-4 lg:gap-8 max-w-7xl mx-auto px-4 md:px-6 lg:px-6 mt-10",
        className,
      )}
    >
      {children}
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* Tech stack */}
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute right-0 top-1/2 -translate-y-1/2 pr-2">
