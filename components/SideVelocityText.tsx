  ...
  return (
    <>
      ...
      <div className="hidden lg:block ">
        {/* LEFT */}
        <div className="fixed left-0 top-0 h-screen w-20 flex items-center justify-center overflow-hidden pointer-events-none z-10 ml-25 bg-[#0f172a] font-bold italic">
      ...
      <div className="lg:hidden w-full overflow-hidden py-6 bg-[#0f172a]">
        <ScrollVelocityContainer>
          <ScrollVelocityRow baseVelocity={8}>
